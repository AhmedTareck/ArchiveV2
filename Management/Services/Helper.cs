    ...
    public class Helper
    {
        ...
        public string GenreatePass(string Year = "1995")
        {
            try
            {
                ...
                return "Moe@" + Year + GenerateRandomNo().ToString();
        ...
        public bool IsValidPhone(string Phone)
        {
            try
            {
                ...
                if (Phone.Substring(0, 2) != "91" && Phone.Substring(0, 2) != "92" && Phone.Substring(0, 2) != "94")
                    return false;
        ...
        public static class BackMessages
        {
            ...
            public static string NoHispital = "لم يتم تنسيبك الي اي مستشفي ";
            ...
            public static string DiseaseExist = "تمت تعبئة بيانات هذا المرض مسبقا";
            ...
            public static string EnterUserNameOrloginName = "الرجاء ادخال البريد الالكتروني او اسم الدخول ";
            public static string RongCradentail = "الرجاء التاكد من البريد الالكتروني وكلمة المرور ";
            public static string Permissions = "ليس لديك صلاحيه للدخول علي النظام";
            public static string NotActive = "حسابك غير مفعل";
            public static string Stopped = "لايمكنك الدخول للنظام: تم ايقافك";
            ...
            public static string RequestCountRong = "عدد الطلبات المقدمة اكبر من عدد الحالات ، الرجاء التأكد من البيانات ربما قمت بتقديم طلب مسبقا";
