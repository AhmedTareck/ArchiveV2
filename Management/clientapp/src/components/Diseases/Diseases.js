...
export default {
    ...
    methods: {
        ...
        GetInfo(pageNo) {
            ...
            this.$blockUI.Start();
            this.$http.GetDiseases(this.pageNo, this.pageSize, this.Type)
                .then(response => {
                    this.$blockUI.Stop();
        ...
        EditItem(item) {
            ...
            this.ruleForm.EngilshName = item.englishName;
        ...
        EditCity(formName) {
            ...
            this.$blockUI.Start();
            this.$http.EditDiseases(this.ruleForm)
                .then(response => {
            ...
            try {
              ...
              for (let index = 0; index < this.Info.length; index++) {
                const element = this.Info[index];
                    ...
                    <td >${element.createdOn.split('T')[0]}</td>
                  </tr>`;
              }
                      ...
                      <div class="box">
                          ...
                          <div class="header-one">
                              ...
                              <div class="center-side" style="text-align:center">
                                  ...
                                  <h3 style="font-weight:bold">قائمة بأسماء الأمراض  </h3>
                              </div>
                          ...
                          <thead>
                              <tr>
                                  <th style="font-size: 2rem;text-align:center">اسم المرض </th>
                                  <th style="font-size: 2rem;text-align:center">اسم المرض (إنجليزي)	</th>
                                  <th style="font-size: 2rem;text-align:center">تاريخ الادراج</th>
                              </tr>
                          </thead>
                          <tbody>
                        ${table}
