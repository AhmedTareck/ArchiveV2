...
export default {
    ...
    methods: {
        ...
        Search() {
            ...
            this.$blockUI.Start();
            this.$http.SearchByDate(this.MunicipalitieId,this.HospitalId,x,y)
                .then(response => {
                    this.$blockUI.Stop();
        ...
        ExportExel() {
            ...
            let y = this.convertDate(this.date2);
            this.$blockUI.Start();
            this.$http.ExportToExcel(this.MunicipalitieId,this.HospitalId, x, y)
                .then(response => {
                    window.open(
                        response.data,
                        '_blank'
            ...
            //                   </tr>
              ...
              for (let index = 0; index < this.Info.length; index++) {
                const element = this.Info[index];
                    ...
                    <td>${element.countCases}</td>

                    <td>${element.male}</td>
                    <td>${element.fmale}</td>
                    <td>${element.libyan}</td>
                    <td>${element.nLibyan}</td>
                      ...
                      <div class="box">
                          ...
                          <div class="header-one">
                              ...
                              <div class="center-side" style="text-align:center">
                                  ...
                                  <h3 style="font-weight:bold">إدارة التقارير </h3>
                              </div>
                          ...
                          <table id="datatable" class="table table-striped table-bordered" cellspacing="0" style="width: -webkit-fill-available;">
                          <thead>
                              <tr>
                                  <th style="font-size: 2rem;text-align:center">نوع المرض</th>
                                  <th style="font-size: 2rem;text-align:center">عدد الحالات</th>
                                  <th style="font-size: 2rem;text-align:center">الذكور</th>
                                  <th style="font-size: 2rem;text-align:center">الاناث</th>
                                  <th style="font-size: 2rem;text-align:center">ليبي الجنسية</th>
                                  <th style="font-size: 2rem;text-align:center">غير ليبي الجنسية</th>
                                  <th style="font-size: 2rem;text-align:center">الوفيات</th>
                                  <th style="font-size: 2rem;text-align:center">تاريخ الإدراج</th>
                              </tr>
                          </thead>
                          <tbody>
                        ${table}
