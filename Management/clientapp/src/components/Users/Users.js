...
export default {
    ...
    methods: {
        ...
        GetInfo(pageNo) {
            ...
            this.$blockUI.Start();
            this.$http.GetUserInfo(this.pageNo, this.pageSize, this.UserType)
                .then(response => {
                    this.$blockUI.Stop();
        ...
        EditItem(item) {
            ...
            this.MunicipalitieId = item.municipalitieId;
            this.EditDialog = true;
            this.GetHospitalsName();
            this.ruleForm.BranchId = item.hospitalId;
        },
                      ...
                      <div class="box">
                          ...
                          <div class="header-one">
                              ...
                              <div class="center-side" style="text-align:center">
                                  ...
                                  <h3 style="font-weight:bold">قائمة بأسماء الراصدين  </h3>
                              </div>
                          ...
                          <table id="datatable" class="table table-striped table-bordered" cellspacing="0" style="width: -webkit-fill-available;" style="height: 2000px;">
                          <thead>
                              <tr>
                                  <th style="font-size: 2rem;text-align:center">الإسم</th>
                                  <th style="font-size: 2rem;text-align:center">رقم الهاتف</th>
                                  <th style="font-size: 2rem;text-align:center">البريد الإلكتروني</th>
                                  <th style="font-size: 2rem;text-align:center">موقع الرصد</th>
                                  <th style="font-size: 2rem;text-align:center">حالة الحساب</th>
                              </tr>
                          </thead>
                          <tbody>
                        ${table}
