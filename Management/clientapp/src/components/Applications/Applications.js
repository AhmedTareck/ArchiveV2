        ...
        async Print() {
            try {
              ...
              if (this.Info.length == 0) {
               return this.showMessage('error', 'خطاء بالعملية', "لا يوجد مستخدمين");
              }
                ...
                const element = this.Info[index];
                    ...
                    table += ` <tr>
                                                    ...
                                                    <td class="td-name " style="text-align:center"  >
                                                        <a>${element.hospital}</a>
                                                    </td>
                                                    <td class="td-name " style="text-align:center">
                                                        <a>${element.diseaseName}</a>
                                                    </td>
                                                    ...
                                                    <td class="td-name " style="text-align:center">
                                                        <a>${element.vaccinationStatus}</a>
                                                    </td>
                                                    <td class="td-name " style="text-align:center">
                                                        <a>${element.notVaccinationStatus}</a>
                                                    </td>
                                                    <td class="td-name " style="text-align:center">
                                                        <a>${element.male}</a>
                                                    </td>
                                                    ...
                                                    <td class="td-name " style="text-align:center">
                                                        <a>${element.lessFive}</a>
                                                    </td>

                                                    <td class="td-name " style="text-align:center">
                                                        <a>${element.overFive}</a>
                                                    </td>
                                                    <td class="td-name " style="text-align:center">
                                                        <a>${element.lessTen}</a>
                                                    </td>
                                                    <td class="td-name " style="text-align:center">
                                                        <a>${element.lessFifteen}</a>
                                                    </td>
                                                    <td class="td-name " style="text-align:center">
                                                        <a>${element.lessTwenty}</a>
                                                    </td>
                                                    <td class="td-name " style="text-align:center">
                                                        <a>${element.lessTwentyFive}</a>
                                                    </td>
                                                    <td class="td-name " style="text-align:center">
                                                        <a>${element.lessThirty}</a>
                                                    </td>
                                                    <td class="td-name " style="text-align:center">
                                                        <a>${element.lessFiveThirty}</a>
                                                    </td>
                                                    <td class="td-name " style="text-align:center">
                                                        <a>${element.lessForty}</a>
                                                    </td>
                                                    <td class="td-name " style="text-align:center">
                                                        <a>${element.lessFortyFive}</a>
                                                    </td>

                                                   

                                                    <td class="td-name " style="text-align:center">
                                                        <a>${element.overFifty}</a>
                                                    </td>
                                                    <td class="td-name " style="text-align:center">
                                                        <a>${element.createdBy}</a>
                                                    </td>
                      ...
                      <div class="box">
                          ...
                          <div class="header-one">
                              ...
                              <div class="center-side" style="text-align:center">
                                  ...
                                  <h3 style="font-weight:bold">تقرير الشهري عن حالات الأمراض السارية و المتوطنة عن شهر: ${new Date().toISOString() .split('T')[0] } </h3>
                                  <h3 style="font-weight:bold">موقع الرصد: ${JSON.parse(localStorage.getItem('currentUser-client')).hospitalName} </h3>
                              </div>
                          ...
                          <table id="datatable" class="table table-striped table-bordered" cellspacing="0" style="width: -webkit-fill-available; margin-top: 50px;">
                          <thead>
                              <tr>
                              <tr>
                              ...
                              <th style="font-size: 1.063rem;text-align: center"> <5 </th>
                              <th style="font-size: 1.063rem;text-align: center"> >10 </th>
                              <th style="font-size: 1.063rem;text-align: center"> >15 </th>
                              <th style="font-size: 1.063rem;text-align: center"> >20 </th>
                              <th style="font-size: 1.063rem;text-align: center"> >25 </th>
                              <th style="font-size: 1.063rem;text-align: center"> >30 </th>
                              <th style="font-size: 1.063rem;text-align: center"> >35 </th>
                              <th style="font-size: 1.063rem;text-align: center"> >40 </th>
                              <th style="font-size: 1.063rem;text-align: center"> >45 </th>
