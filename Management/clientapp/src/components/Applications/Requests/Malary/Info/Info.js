...
export default {
    ...
    created() {
        ...
        this.selectedItem = this.$parent.SelectMalary;
        this.GetInfo();
    ...
    methods: {
        ...
        GetInfo() {
            ...
            this.$blockUI.Start();
            this.$http.GetMalaryFormsById(this.selectedItem.id)
                .then(response => {
                    this.$blockUI.Stop();
                        ...
                        <div class="box">
                            ...
                            <div class="header-one">
                                ...
                                <div class="center-side" style="text-align:center">
                                    ...
                                    <h3> (استبيان لداء البرداء "الملاريا")</h3>
                                </div>
                            ...
                            <div class="content-place">
                                ...
                                <table>
                                    <tr>
                                        <th class="header">رقم الهاتف:${item.phone}</th>
                                    </tr>
                                </table>
                                <br />
                            </div>
                            ...
                            <div class="content-place">
                                <table>
                                    <tr>
                                        ...
                                        <th class="header"  style="width: 60px;">مقيم: ${item.resident}</th>
                                        <th class="header"  style="width: 60px;">غير مقيم: ${item.nonResident}</th>
                            ...
                            <div class="content-place">
                                <table>
                                    <tr>
                                        <th class="header"  style="width: 60px;">مكان وتاريخ السفر: ${item.dateTravel==null?'-':item.dateTravel.split('T')[0]}</th>
                                        <th class="header"  style="width: 60px;">أين: ${item.placeTravel}</th>
                            ...
                            <div class="content-place">
                                <table>
                                    <tr>
                                        <th class="header">تاريخ ضهور الأعراض: ${item.symptomsDate==null?'-':item.symptomsDate.split('T')[0]}</th>
                                    </tr>
                                </table>
                                <br />
                            </div>
                            ...
                            <div class="content-place">
                                <table>
                                    <tr>
                                        <th class="header"  style="width: 60px;">هل اصيب بداء البرداء سابقا: ${item.isColdBefore==1?'نعم':"لا"}</th>
                                        <th class="header"  style="width: 60px;">ما نوع الطفيل: ${item.coldType}</th>
                            ...
                            <div class="content-place">
                                <table>
                                    <tr>
                                        <th class="header"  style="width: 60px;">هل تم نقل الدم: ${item.isBloodTransfer}</th>
                                        <th class="header"  style="width: 60px;">متى: ${item.bloodTransferOn==null?'-':item.bloodTransferOn.split('T')[0]}</th>
                            ...
                            <div class="content-place">
                                <table>
                                    <tr>
                                        <th class="header"  style="width: 60px;">هل هناك سابقة إيواء بالمستشفى: ${item.isHospitalBefore==1?'نعم':"لا"}</th>
                                        <th class="header"  style="width: 60px;">السبب: ${item.resone}</th>
                                    </tr>
                                </table>
                                <br />
                            </div>
                            ...
                            <div class="content-place">
                                <table>
                                    <tr>
                                        <th class="header">هل كانت الام مصابة اثناء فترة الحمل:${item.isMotherInfected==1?'نعم':"لا"} </th>
                                        <th class="header" ></th>
                                        <th class="header" ></th>
                            ...
                            <div class="content-place">
                                <table>
                                    <tr>
                                        <th class="header">هل تم التأكيد من الإصابة مخبريا: ${item.isConfirmInfected==1?'نعم':"لا"}</th>
                                        <th class="header" >نوع الطفيل: ${item.infectedType}</th>
                                        <th class="header" ></th>
                                    </tr>
                                </table>
                                <br />
                            ...
                            <div class="content-place">
                                <table>
                                    <tr>
                                        <th class="header">مع إرفاق شريحة أو اكثر مع الإستبيان:-</th>
                                    </tr>
                                </table>
                                <br />
                            </div>
                            <div class="content-place">
                                <table>
                                    <tr>
                                        <th class="header">هل تم الإيواء في المستشفى: ${item.isHospital==1?'نعم':"لا"}</th>
                                        <th class="header" >تاريخ: ${item.hospitalOn==null?'-':item.hospitalOn.split('T')[0]} </th>
                                        <th class="header" ></th>
                                    </tr>
                                </table>
                                <br />
                            ...
                            <div class="content-place">
                                <table>
                                    <tr>
                                        <th class="header"  >ما نوع العلاج: ${item.treatmentType}</th>
                                    </tr>
                                </table>
                                <br />
                            </div>
                            ...
                            <div class="content-place">
                                <table>
                                    <tr>
                                        <th class="header"  >هل اكمل العلاج: ${item.isCompleteTreatment==1?'نعم':"لا"}</th>
                                    </tr>
                                </table>
                                <br />
                            </div>
                            <div class="content-place">
                                <table>
                                    <tr>
                                        <th class="header" style="width: 60px;">وضع المريض: ${item.patintType==1?'شفي':item.patintType==2?"تحت المتابعة":'توفى'} </th>
                                        <th class="header" style="width: 60px;">التاريخ: ${item.dateOn==null?'-':item.dateOn.split('T')[0]}</th>
                                        <th class="header" style="width: 60px;" ></th>
                                    </tr>
                                </table>
                                <br />
                            ...
                            <div class="content-place">
                                <table>
                                    <tr>
                                        <th class="header" >هل توجد بالمنطقة أحواض مائية: ${item.isAquariums==1?'احواض مائية':item.isAquariums==2?'برك':item.isAquariums==3?'مستنقعات':item.isAquariums==4?'خزانات مفتوحة':item.isAquariums==5?'ينابيع':'-'}</th>
                                        <th class="header" ></th>
                                        <th class="header" ></th>
                            ...
                            <div class="content-place">
                                <table>
                                    <tr>
                                        <th class="header" >هل توجد موانع للحشرات على النوافذ: ${item.patintType==1?'نعم':"لا"}</th>
                                        <th class="header" ></th>
                                        <th class="header" ></th>
                            ...
                            <div class="content-place" >
                                <table>
                                    <tr>
                                        ...
                                        <th class="header" style="width:30%"> رقم الهاتف: ${item.informerPhone}</th>
                                    </tr>
                                </table>
                                <br />
                            </div>
                            ...
                            <div class="content-place">
                                <table>
                                    <tr>
                                        <th class="header" style="width:60%">التاريخ: ${item.deateOn.split('T')[0]}</th>
