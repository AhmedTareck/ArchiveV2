...
export default {
    ...
    methods: {
        ...
        GetInfo() {
            this.$blockUI.Start();
            this.$http.GetEbolaFormsById(this.selectedItem.id)
                .then(response => {
                    this.$blockUI.Stop();
                    ...
                    <div class="box">
                        ...
                        <div class="header-one">
                            ...
                            <div class="center-side" style="text-align:center">
                                <h2>دولــــــــــــــــة لــــــــــيـبـيـــــــــا</h2>
                                <h2>وزارة الصحـــــــــــــــــــــــــــــة</h2>
                                <h3>المــركز الوطنــــي لمكافحــة الأمــــراض </h3>
                                <h2>إدارة الرصد والإستجابة السريعة  </h2>
                                <h3 style="font-weight:bold">استبيان عن حالات اشتباه مرض ايبولا  </h3>
                            </div>
                        ...
                        <!-- Header Two -->
                        <div class="content-place" style="margin-top:15px">
                            <table>
                                <tr>
                                    <th class="header">المدينة: - </th>
                                    <th class="header">  </th>
                                    <th class="header" style="float:left">التاريخ:${item.createdOn == ''?'-':item.createdOn == null?'-':item.createdOn.split('T')[0]}</th>
                                </tr>
                            </table>
                            <br />
                        </div>
                        ...
                        <div class="content-place">
                            <table>
                                <tr>
                                    <th class="header" style="width:50%">الاسم:${item.fullName}</th>
                                    <th class="header" style="width:25%">العمر:${item.age}</th>
                                    <th class="header" style="width:25%">الجنس:${item.gender==1?'ذكر':'أنثى'}</th>
                                </tr>
                            </table>
                            <br />
                        </div>
                        ...
                        <div class="content-place">
                            <table>
                                <tr>
                                    <th class="header" style="width:35%">مقيم:${item.resident}</th>
                                    <th class="header" style="width:35%">غير مقيم: ${item.nonResident}</th>
                                </tr>
                        ...
                        <div class="content-place">
                            <table>
                                <tr>
                                    <th class="header" style="width:70%">مكان وتاريخ السفر:${item.dateTravel == ''?'-':item.dateTravel == null?'-':item.dateTravel.split('T')[0]}</th>
                                    <th class="header" style="width:30%">أين:${item.placeTravel}</th>
                                </tr>
                        ...
                        <div class="content-place">
                            <table>
                                <tr>
                                    <th class="header" style="width:50%">عنوان السكن: ${item.home}</th>
                                    <th class="header" style="width:50%">اقرب نقطة داله: ${item.mahla}</th>
                                </tr>
                        ...
                        <div class="content-place">
                            <table>
                                <tr>
                                    <th class="header" style="width:70%">المهنة ومكان العمل: ${item.jobInfo} </th>
                                    <th class="header" style="width:30%">الهاتف: ${item.phone}</th>
                                </tr>
                        ...
                        <div class="content-place">
                            <table>
                                <tr>
                                    <th class="header" style="width:35%">الاعراض تاريخ الظهور: ${item.symptomsDate == ''?'-':item.symptomsDate == null?'-':item.symptomsDate.split('T')[0]} </th>
                                    <th class="header" style="width:65%">الأعراض: </th>
                                </tr>
                        ...
                        <div class="content-place">
                            <table>
                                <tr>
                                    <th class="header" style="width:30%">حمي: ${item.fever}</th>
                                    <th class="header" style="width:30%">صداع: ${item.headache}</th>
                                    <th class="header" style="width:50%">ألام بالمفاصل والعضلات: ${item.musclePain}</th>
                                </tr>
                        ...
                        <div class="content-place">
                            <table>
                                <tr>
                                    <th class="header" style="width:30%">قيئ: ${item.vomiting}</th>
                                    <th class="header" style="width:30%">إسهال دموي: ${item.bloodyDiarrhea} </th>
                                    <th class="header" style="width:50%">نزيف من فتحات الجسم: ${item.bleeding} </th>
                                </tr>
                        ...
                        <div class="content-place">
                            <table>
                                <tr>
                                    <th class="header" style="width:100%">أعراض أخري: ${item.other}</th>
                                </tr>
                            ...
                            <table>
                                <tr>
                                    <th class="header" style="width:100%">
                                        ...
                                        <h3 style="font-weight:bold">المخالطين : ${item.famileyContacts==1?'نعم':"لا"} </h3>
                                    </th>
                                </tr>
                        ...
                        <div class="content-place">
                            <table>
                                <tr>
                                    <th class="header" style="width:50%">هل توجد حالات بين أفراد الأسرة: ${item.famileyContacts==1?'نعم':"لا"}</th>
                                    <th class="header" style="width:50%">هل توجد حالات بين زملاء العمل: ${item.worckContacts==1?'نعم':"لا"}</th>
                                </tr>
                        ...
                        <div class="content-place">
                            <table>
                                <tr>
                                    <th class="header" style="width:100%">حالة المريض وقت كتابة الاستبيان: ${item.patintStatusNow}</th>
                                </tr>
                        ...
                        <div class="content-place">
                            <table>
                                <tr>
                                    <th class="header" style="width:30%">مكان ايواء المريض:  </th>
                                    <th class="header" style="width:30%"> المستشفي:${item.hospital} </th>
                                    <th class="header" style="width:50%">المنزل: ${item.home}</th>
                                </tr>
                        ...
                        <div class="content-place" style="margin-top:20px">
                            <table>
                                <tr>
                                    <th class="header" style="width:60%">اسم كاتب الإستبيان: ${item.informerName}</th>
                                    <th class="header" style="width:30%"> التوقيع: .........................</th>
                                    <th class="header" style="width:30%">التاريخ:.........................</th>
                                </tr>
