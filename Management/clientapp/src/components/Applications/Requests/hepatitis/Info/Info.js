...
export default {
  ...
  methods: {
    ...
    GetInfo() {
      this.$blockUI.Start();
      this.$http.GetImmediateFormById(this.$parent.SelectedItem.id)
        .then(response => {
          this.$blockUI.Stop();
      ...
      try {
        ...
        <body dir="rtl">
            ...
            <div>
                <div class="box">
                    <!-- Header One -->
                    <div class="header-one" style="margin-top: 50px;">
                        ...
                        <div class="center-side" style="text-align:center">
                            ...
                            <h3>استبيان عن اشتباه التهاب الكبد أ</h3>
                        </div>
                    ...
                    <div class="content-place" style="margin-top:15px">
                        <table>
                            <tr>
                                <th class="header">الاسم: ${item.name}</th>
                                <th class="header"> العمر: ${item.age} </th>
                                <th class="header">نوع: ${item.gender==1?'ذكر':'انثى' }</th>
                            </tr>
                        </table>
                        <br />
                    </div>
                    ...
                    <div class="content-place">
                        <table>
                            <tr>
                                ...
                                <th class="header" >عنوان السكن: ${item.locations}</th>
                                <th class="header" >المدرسة: ${item.city}</th>
                            </tr>
                        </table>
                        <br />
                    </div>
                    ...
                    <div class="content-place">
                        <table>
                            <tr>
                                <th class="header" style="width: 60px;" >حمى: [ نعم ]</th>
                                <th class="header" style="width: 60px;">غثيان: [ نعم ]</th>
                    ...
                    <div class="content-place">
                        <table>
                            <tr>
                                <th class="header" style="width: 60px;">فقدان الشهية: [ نعم ]</th>
                                <th class="header" style="width: 60px;">ألام بطنية: [ نعم ]</th>
                                <th class="header" style="width: 60px;" ></th>
                    ...
                    <div class="content-place">
                        <table>
                            <tr>
                                <th class="header" style="width: 60px">يرقان:[ نعم ]</th>
                                <th class="header" style="width: 60px;" >إسهال:[ نعم ]</th>
                                <th class="header"style="width: 60px;" >قيء:[ نعم ]</th>
                            </tr>
                        </table>
                        <br />
                    </div>
                    ...
                    <div class="content-place">
                        <table>
                            <tr>
                                <th class="header">الإختبارات المعملية:</th>
                            </tr>
                        </table>
                        <br />
                    </div>
                    ...
                    <div class="content-place">
                        <table>
                            <tr>
                                <th class="header" style="width: 50%;">إختبار البول</th>
                                <th class="header"  >تاريخ:...............</th>
                    ...
                    <div class="content-place">
                        <table>
                            <tr>
                                <th class="header" style="width: 50%;">:إختبار وظائف الكبد</th>
                                <th class="header" >تاريخ:...............</th>
                    ...
                    <div class="content-place">
                        <table>
                            <tr>
                                <th class="header" style="width: 50%;">:إختبارات سيرولوجية</th>
                                <th class="header"  >تاريخ:...............</th>
                    ...
                    <div class="content-place">
                        <table>
                            <tr>
                                <th class="header" >تاريخ ظهور الأعراض: ..........................</th>
                            </tr>
                        </table>
                        <br />
                    </div>
                    ...
                    <div class="content-place">
                        <table>
                            <tr>
                                <th class="header" >دخول للمستشفى: [ نعم ]</th>
                                <th class="header">العلاج:.........................</th>
                                <th class="header">تاريخ الخروج:.........................</th>
                            </tr>
                        ...
                        <table>
                            <tr>
                                <th class="header" style="width:100%">
                                    ...
                                    <h3 style="font-weight:bold">المخالطين للمريض :................................. </h3>
                                </th>
                            </tr>
                    ...
                    <div class="content-place">
                        <table>
                            <tr>
                                <th class="header" style="width:30%">الاسم:................</th>
                                <th class="header" style="width:30%">العنوان:................</th>
                                <th class="header" style="width:30%">رقم الهاتف:.........................</th>
                            </tr>
                    ...
                    <div class="content-place">
                        <table>
                            <tr>
                                <th class="header" style="width:100%">مصدر المياه الشرب :................</th>
                    ...
                    <div class="content-place">
                        <table>
                            <tr>
                                <th class="header" style="width:50%">الأكل الخارج المنزل :................</th>
                            </tr>
                        </table>
                        <br />
                    </div>
                    <div class="content-place" style="margin-bottom: 20px; margin-top: 50px;">
                        <table>
                            <tr>
                                <th class="header" style="width:60%">اسم كاتب الإستبيان: </th>
