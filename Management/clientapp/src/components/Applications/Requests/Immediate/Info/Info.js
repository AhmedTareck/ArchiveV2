        ...
        <div class="box">
            ...
            <div class="header-one">
                ...
                <div class="center-side" style="text-align:center">
                    ...
                    <h3 style="font-weight:bold">استبيان عن حالات اشتباه مرض ${item.diseaseInfo}  </h3>
                </div>
            ...
            <div class="content-place" style="margin-top:15px">
                <table>
                    <tr>
                        <th class="header">الوحدة الصحية: ${item.unit}</th>
                        <th class="header"> عنوانها: ${item.hospitalLocations} </th>
            ...
            <div class="content-place" style="margin-top:15px">
                <table>
                    <tr>
                        <th class="header" style="width:29%">الاسم: ${item.name}</th>
                        <th class="header" style="width:25%">العمر: ${item.age}</th>
                        <th class="header" style="width:25%">الجنس:${item.gender ==1?'ذكر':"انثى"}</th>
                    </tr>
                </table>
                <br />
            </div>
            ...
            <div class="content-place" style="margin-top:15px">
                <table>
                    <tr>
                        ...
                        <th class="header">المدينة: ${item.city}</th>
                        <th class="header">المحلة: ${item.mahla}</th>
                        <th class="header">نقطة دالة: ${item.locations}</th>
                    </tr>
                </table>
                <br />
            </div>
            ...
            <div class="content-place" style="margin-top:15px">
                <table>
                    <tr>
                        <th class="header" style="width:35%">المهنة الحالية ومكان العمل: ${item.jobInfo} </th>
                    </tr>
            ...
            <div class="content-place" style="margin-top:15px">
                <table>
                    <tr>
                        <th class="header" style="width:70%">المرض المشتبه به ورقم الدولي: ${item.diseaseInfo}</th>
                    </tr>
            ...
            <div class="content-place" style="margin-top:15px">
                <table>
                    <tr>
                        <th class="header" style="width:50%">تاريخ ظهور المرض: ${item.diseaseDateOn == ''?'-':item.diseaseDateOn == null?'-':item.diseaseDateOn.split('T')[0]}</th>
                        <th class="header" style="width:50%">تاريخ اكتشاف الحالة: ${item.findOn == ''?'-':item.findOn == null?'-':item.findOn.split('T')[0]} </th>
                    </tr>
            ...
            <div class="content-place" style="margin-top:15px">
                <table>
                    <tr>
                        <th class="header" style="width:50%">الاجراءات التي تم اتخادها: ${item.actionsInfo} </th>
                    </tr>
            ...
            <div class="content-place" style="margin-top:15px">
                <table>
                    <tr>
                        <th class="header" style="width:50%">تاريخ تعبئة النموذج: ${item.deateOn == ''?'-':item.deateOn == null?'-':item.deateOn.split('T')[0]} </th>


                        <th class="header" style="width:50%">المستخدم: ${item.createdBy} </th>
                    </tr>
