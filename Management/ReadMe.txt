...
ALTER SCHEMA dbo
    ...
    Scaffold-DbContext "server=DESKTOP-G795488;database=ArchiveV2;uid=Ahmed;pwd=35087124567Ahmed" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models -F
    Scaffold-DbContext "server=ISPRD-MI05;database=SpeedEx;Trusted_Connection=True" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models -F

     Scaffold-DbContext "server=DESKTOP-QBJAMNI;database=Estbian;uid=Ahmed;pwd=35087124567Ahmed;Trusted_Connection=false;MultipleActiveResultSets=true;" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models 

    Scaffold-DbContext "server=DESKTOP-QBJAMNI;database=Estbian;uid=Ahmed;pwd=35087124567Ahmed;Trusted_Connection=false;MultipleActiveResultSets=true;" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models -F
